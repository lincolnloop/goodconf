...
def test_undefined():
    """Undefined attributes raise AttributeError via pydantic's BaseModel.__getattr__.

    GoodConf previously defined its own __getattr__ (removed in 9e80965).
    The behaviour is now delegated to pydantic:
